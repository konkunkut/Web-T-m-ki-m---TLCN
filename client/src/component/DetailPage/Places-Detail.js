...
import { Col, Row, Divider, BackTop, Layout, Rate, Icon, Progress, Avatar, Tag } from 'antd';
                    ...
                    <Col span={15} className="places-decription">
                        ...
                        <Row style={{ marginTop: 10 }}>
                            ...
                            <Row className="decription-full">
                                <p>
                                    <Icon type="environment" /> {this.props.location.state.add}
                                </p>
                                <p>
                                    <Icon type="phone" /> {this.props.location.state.tel}
                                </p>
                                <p>
                                    Mô tả:
                            </p>
